                    ...
                    <div className="p-5">
                        ...
                        <form onSubmit={(e) => handleSubmit(e)} className="d-flex flex-column col-4">
                            <div className="mt-4 d-flex flex-column">
                                ...
                                }} value={formData.name} className="form-control" type="text" id="name" name="name"/>
                            </div>
                            <div className="mt-4 d-flex flex-column">
                                ...
                                }} value={formData.displayName} className="form-control" type="text" id="displayName"
                                       name="displayName"/>
                            </div>
                            <div className="mt-4 d-flex flex-column">
                                ...
                                }} value={formData.description} className="form-control" id="description"
                                          name="description"/>
                            </div>
                            <div className="mt-4 d-flex flex-column">
